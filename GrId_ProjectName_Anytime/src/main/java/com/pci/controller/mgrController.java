...
*/	
	@RequestMapping(value = "/dummyManager", method = RequestMethod.POST)
	public ModelAndView mgrDummy(ModelAndView mav ,Authentication authentication) {
//		MtUser loginUser = logiUser(authentication);
//		mav.addObject("loginUser", loginUser);
		mav.setViewName("100mgr/110mgrFunction");		
		return mav;
	}
